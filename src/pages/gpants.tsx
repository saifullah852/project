...
export default function Nav () {
 return (
   ...
   <title>SZ MINI MART</title>
      ...
      <Link className="ml-10  mr-16 hover:text-red-900" href={"http://localhost:3001"}>Home</Link>
      
      <Link className="mr-16 hover:text-blue-900" href={"http://localhost:3001/helpandsupport"}>Help and Support</Link>
...
<section className="text-gray-600 body-font overflow-hidden">
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="t-shirt" className="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRynh6cGVEbHBYFk2RHBv1lBYfR3P0rYbPsXQ&s"/>
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        <h2 className="text-sm title-font text-gray-500 tracking-widest">SZ Girls pant</h2>
        <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">NEW DESIGNS FOR NEW GENERATION</h1>
        ...
        <p className="leading-relaxed">SZ mini mart presented this new design girls pants for our new generation. This provides comfort to our customer.</p>
        ...
        <div className="flex">
          <span className="title-font font-medium text-2xl text-gray-900">Rupees:2800</span>
