...
<section className="text-gray-600 body-font overflow-hidden">
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="t-shirt" className="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="https://ae-pic-a1.aliexpress-media.com/kf/H1546a5c62470459fb4ce2622d91e42a0W/2023-CHOLYL-New-Light-Blue-Skinny-Jeans-Men-Spring-Summer-Slim-Denim-Jeans-Men-Cotton-Elastic.jpg_640x640Q90.jpg_.webp"/>
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        <h2 className="text-sm title-font text-gray-500 tracking-widest">SZ mens pants</h2>
        ...
        <p className="leading-relaxed">SZ mini mart presented this new new design denim pants for our new generation. This provides comfort to our customer.</p>
        ...
        <div className="flex">
          <span className="title-font font-medium text-2xl text-gray-900">Rupees:2500</span>
