...
<section className="text-gray-600 body-font overflow-hidden">
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="t-shirt" className="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="https://www.rafia.pk/cdn/shop/files/DPCK-156_1_600x.jpg?v=1719553913"/>
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        <h2 className="text-sm title-font text-gray-500 tracking-widest">SZ Girls kurti</h2>
        ...
        <p className="leading-relaxed">SZ mini mart presented this  new design kurti for our new generation. This provides comfort to our customer.</p>
        ...
        <div className="flex">
          <span className="title-font font-medium text-2xl text-gray-900">Rupees:1800</span>
